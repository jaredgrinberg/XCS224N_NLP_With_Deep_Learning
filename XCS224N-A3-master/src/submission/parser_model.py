...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        batch_size = t.size()
        x = self.pretrained_embeddings(t).view(batch_size[0], self.n_features * self.embed_size)
        ### END CODE HERE
        return x
    ...
    def forward(self, t):
        ...
        relu = F.relu(hidden)
        dropped_hidden_relu = self.dropout(relu)
        logits = self.hidden_to_logits(dropped_hidden_relu)
        ### END CODE HERE
        return logits
